...
const input = document.getElementById("todoinput") as HTMLInputElement; // Here "as HTMLInputElement" is a Type Assertions, means I manually said that what is the exact type of the input.
 ...
 *
 */
function showTodos(allTodos: TODO[]) {
